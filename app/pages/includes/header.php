        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="dropdown text-end">
                ...
                <ul class="dropdown-menu text-small">
                    ...
                    <li><a class="dropdown-item" href="<?=ROOT?>/edit_user">Edit profile</a></li>
                        <li><a class="dropdown-item" href="<?=ROOT?>/post_user">Add post</a></li>
                    <?php endif;?>
            ...
            <?php endif;?>
            <?php if(!logged_in()):?>
                <a href="<?=ROOT?>/login"><button class="btn btn-primary">Login</button></a>
            <?php endif;?>
        </div>
    </div>
</header>
