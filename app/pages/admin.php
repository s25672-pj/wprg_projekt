...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <span class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Controller</span>
            ...
            <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 <?=$section == 'dasboard'? 'active':''?>" aria-current="page" href="<?=ROOT?>/admin">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 <?=$section == 'comments'? 'active':''?> " aria-current="page" href="<?=ROOT?>/admin/comments">
                                <i class="bi bi-file-post"></i>
                                Comments
                            </a>
                        </li>
